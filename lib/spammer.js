 ...
 * @param {Object} _data
 */
 const addSpam = (userId, expired, _data) => {
    let success = false
    ...
    _data.push(obj)
    fs.writeFileSync('./database/spamban.json', JSON.stringify(_data))
}
/**
 * Unbanned someone.
 * @param {String} userId 
...
const SpamExpired = (_dir) => {
    setInterval(() => {
        ...
        if (position !== null) {
            ...
            fs.writeFileSync('./database/spamban.json', JSON.stringify(_dir))
        }
    }, 1000)
}
/**
